                            ...
                            <div class="row gy-3 align-items-end">
                                ...
                                <div class="col-xl-3 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="date" value="" id="date" data-range="true"
                                ...
                                <div class="col-xl-2 col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="adult" id="adult" autocomplete="off"
                                            value="" min="1" class="form--control">
                                    </div>
                                </div>
                                <div class="col-xl-2 col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="child" id="child" autocomplete="off"
                                            value="" min="0" class="form--control">
                                    </div>
                                </div>
                                    ...
                                    <select class="select select-sm propertyType">
                                        ...
                                        {{-- @foreach ($propertyTypes as $propertyType)
                                            <option value="{{ $propertyType->id }}"
                                                {{ $request->propertyType == $propertyType->id ? 'selected' : '' }}>
                                                {{ __($propertyType->name) }}</option>
                                        @endforeach --}}
                            ...
                            <div class="action-widget">
                                ...
                                <div class="action-widget__body">
                                    ...
                                    <div class="form-check custom--checkbox d-flex justify-content-between">
                                        <div class="left">
                                            <input class="form-check-input star-lev-check" type="checkbox" value="1"
                                                id="starCheckbox-1">
                                            <label class="form-check-label" for="starCheckbox-1">
                                                1 @lang('Stars')
                                            </label>
                                        </div>
                            ...
                            <div class="action-widget">
                                ...
                                <div class="action-widget__body scroll--active">
                                    ...
                                    <div class="form-check custom--checkbox d-flex justify-content-between pe-2">
                                        <div class="left">
                                            <input class="form-check-input amenity-check" type="checkbox" value="1"
                                                id="checkbox-1">
                                ...
                                <div class="hotel-card__action">
                                    <div class="bottom w-100">
                                        <div class="price text--base">
                                            ...
                                            <span
                                                class="{{ $highestPrice > 9999 ? 'd-block' : '' }}">{{ $general->cur_sym . showAmount($lowestPrice) }}</span>
                                            -
                                            <span
                                                class="{{ $highestPrice > 9999 ? 'd-block' : '' }}">{{ $general->cur_sym . showAmount($highestPrice) }}</span>
                                        </div>
