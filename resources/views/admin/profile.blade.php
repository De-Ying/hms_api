                                        ...
                                        <div class="thumb">
                                            <div class="avatar-preview">
                                                <div class="profilePicPreview"
                                                    style="background-image: url({{ getImage(imagePath()['profile']['admin']['path'] . '/' . $admin['image'], imagePath()['profile']['admin']['size']) }})">
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.password', $admin['id']) }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i
